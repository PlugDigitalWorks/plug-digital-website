...
const WatchForm: React.FC<WatchFormProps> = ({
  ...
  const defaultAdditionalKeys = new Set(['Gender', 'Box & Papers', 'Location']);
    ...
    const fetchData = async () => {
      try {
        const [categoriesRes, brandsRes] = await Promise.all([
          fetch('/api/categories?type=WATCH'),
          fetch('/api/brands?type=WATCH'),
        ]);
  ...
  const handleInputChange = (field: keyof WatchFormData, value: any) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit(submitData as unknown as WatchFormData);
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <select
              value={formData.selectedBrand || initialData?.selectedBrand || ''}
              onChange={(e) =>
      ...
      {/* Basic Info - Dynamic */}
      <div className="bg-white p-6 rounded-lg shadow">
        <h3 className="text-lg font-semibold mb-4">Watch Basic Information</h3>

        {/* Default watch fields (quick select + free typing) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Condition'] || ''}
              onChange={(e) => handleBasicInfoChange('Condition', e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Case Size'] || ''}
              onChange={(e) => handleBasicInfoChange('Case Size', e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Case Material'] || ''}
              onChange={(e) =>
                handleBasicInfoChange('Case Material', e.target.value)
              }
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Dial'] || ''}
              onChange={(e) => handleBasicInfoChange('Dial', e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Movement'] || ''}
              onChange={(e) => handleBasicInfoChange('Movement', e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Bracelet'] || ''}
              onChange={(e) => handleBasicInfoChange('Bracelet', e.target.value)}
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Water Resistance'] || ''}
              onChange={(e) =>
                handleBasicInfoChange('Water Resistance', e.target.value)
              }
          ...
          <div>
            ...
            <input
              type="text"
              value={formData.basicInfo['Caseback'] || ''}
              onChange={(e) => handleBasicInfoChange('Caseback', e.target.value)}
        ...
        <div className="flex gap-2 items-end">
          <div className="flex-1">
            ...
            <input
              ...
              placeholder="Field name (e.g., Model, Year)"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              onKeyPress={(e) => {
                if (e.key === 'Enter') {
                  e.preventDefault();
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <input type="text" value={formData.additionalInfo['Gender'] || ''} onChange={(e) => handleAdditionalInfoChange('Gender', e.target.value)} placeholder="e.g. Men's" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
        ...
        {Object.entries(formData.additionalInfo)
          .filter(([key, value]) => key !== 'seo' && !defaultAdditionalKeys.has(key) && value !== null && value !== undefined)
          .length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            {Object.entries(formData.additionalInfo)
        ...
        <div className="flex gap-2 items-end">
          <div className="flex-1">
            ...
            <input
              ...
              placeholder="Field name (e.g., Clasp, Case Diameter)"
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              onKeyPress={(e) => {
                if (e.key === 'Enter') {
                  e.preventDefault();
